...
public class Ficha  implements java.io.Serializable {
    ...
    public Ficha(Date dataEntrada, String sexo, float peso, String medicacao, String acompanhamento, String problemaSaude, float altura, String objetivo, String profissao, int idCliente, float frequenciacardrep, float frequenciacardMax, float calculoFcm, int idade) {
